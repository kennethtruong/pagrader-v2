/* http://prismjs.com/download.html?themes=prism&languages=clike+c+java&plugins=line-numbers */
var _self =
                  ...
                  if (!(v instanceof a)) {
                    ...
                    if (!b && h && m != r.length - 1) {
                      ...
                      for (
                        ...
                        (S += (r[A].matchedStr || r[A]).length), w >= S &&
                          (++m, (y = S));
                    ...
                    if (b) {
                      ...
                      j.push(N), O && j.push(O), Array.prototype.splice.apply(
                        r,
                        j
                      );
                    }
      ...
      if (e.code) {
        ...
        if (
          ...
          s.test(e.element.className) &&
            (e.element.className = e.element.className.replace(s, '')), s.test(
            t.className
          ...
          (r = r.join('<span></span>')), (n = document.createElement(
            'span'
          )), n.setAttribute('aria-hidden', 'true'), (n.className =
            'line-numbers-rows'), (n.innerHTML = r), t.hasAttribute(
            'data-start'
          ) &&
            (t.style.counterReset =
              'linenumber ' +
              (parseInt(t.getAttribute('data-start'), 10) -
                1)), e.element.appendChild(n);
        }
      }
    });
})();
